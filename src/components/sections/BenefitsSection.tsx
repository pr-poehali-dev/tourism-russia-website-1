...
const BenefitsSection = () => {
  ...
  const benefits: Benefit[] = [
    ...
    { 
      ...
      description: "Небольшие группы 8-12 человек для комфортных путешествий и общения с природой. Мы учитываем физическую подготовку и пожелания каждого участника. Никого не оставим позади, всегда поможем и поддержим." 
    },
  ];
