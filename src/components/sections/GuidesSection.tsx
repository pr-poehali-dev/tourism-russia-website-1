  ...
  const guides: Guide[] = [
    {
      ...
      achievements: [
        "Восхождение на г. Эльбрус 2017 и 2023 годы (участие)",
        "Восхождение на г. Демавенд (помощник гида)",
        "Восхождением на г. Пабаку в 2023 и 2024 годах (организовывал и проводил)",
