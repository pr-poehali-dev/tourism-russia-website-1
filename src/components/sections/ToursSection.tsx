...
const ToursSection = () => {
  ...
  const tours: Tour[] = [
    ...
    },
    {
      ...
      duration: "Приглашаю в путешествие по зимнему Байкалу вокруг острова Ольхон! Эта поездка – уникальная возможность прокатиться на коньках по самому большому катку в мире и по уши втрескаться в его необыкновенные ледяные узоры.\n\n<strong>Будем перемещаться пешком, на коньках, помогая себе специальными палками, жить будем в отапливаемых палатках с печкой прямо посреди байкальских ледяных просторов!</strong>\n\nВам не придется таскать на себе тяжелые рюкзаки, для это в походе предусмотрены сани-волокуши. Это надежно, удобно и легко! Присоединяйтесь!",
      price: "61 000 ₽",
      difficulty: "Легкий",
