...
const ToursSection = () => {
  ...
  const tours: Tour[] = [
    ...
    },
    {
      ...
      description: "6-12 марта 2026 года",
    ...
    },
    {
      ...
      subtitle: "Каменный город, Усьвинские столбы, Ветлан, Колчимский камень",
      description: "Даты по запросу",
      duration: "Приключения по самым живописным местам Урала! <strong>Каменный город</strong>, <strong>Усьвинские столбы</strong>, камни-богатыри <strong>Ветлан и Полюд</strong>, легендарный <strong>Колчимский камень-колдун</strong>.\n\n<strong>От однодневных экскурсий за 4000₽ до полноценного 4-дневного тура за 28 000₽. Трансфер, питание и проживание включены!</strong>",
      price: "от 4 000 ₽",
      difficulty: "Легкий",
