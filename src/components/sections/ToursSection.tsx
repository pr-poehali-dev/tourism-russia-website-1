  ...
  const tours: Tour[] = [
    {
      ...
      duration: "За 7 дней мы преодолеем несколько десятков километров по льду и познакомимся с достопримечательностями острова Ольхон: мысом Хобой, скалами Три Брата и Шаманка, буддийской ступой на острове Огой и многим другим! Передвигаться будем на коньках, пешком и автомобилях повышенной проходимости. Все ночёвки запланированы на тёплых турбазах.",
      price: "75 000 ₽",
      difficulty: "Легкий",
