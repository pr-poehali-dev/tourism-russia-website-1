...
const TourKolyma = () => {
  ...
  const program = [
    ...
    },
    {
      day: "2-й день",
      distance: "56 км",
      title: "К озеру Джека Лондона на вахтовке",
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card>
              <CardContent className="p-6 md:p-8">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">О путешествии</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {tourInfo.map((info, index) => (
                    <div key={index} className="flex items-start gap-3">
                      <Icon name={info.icon} size={20} className="text-primary mt-1 flex-shrink-0" />
                      <div>
