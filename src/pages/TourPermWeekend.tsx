            ...
            <Card className="md:col-span-2">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-gray-700">
                  ...
                  <p>
                    Предлагаю как <strong>однодневные экскурсии от 4000 ₽</strong> с человека (выезд из Перми и возвращение в тот же день), так и многодневные туры. Например, 4-дневное путешествие в зимнюю сказку с посещением всех топовых локаций – <strong>всего 28 000 ₽</strong> с человека!
                  </p>
                  <p>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-center mb-6">
                  <div className="text-4xl md:text-5xl font-bold text-primary mb-2">
                    от 4 000 ₽<span className="text-sm text-black font-normal">/1 день</span>
                  </div>
                  <div className="text-sm text-muted-foreground">28 000 ₽ за 4 дня</div>
                </div>
